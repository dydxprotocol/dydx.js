const web3Instance = require('web3-utils')
...
module.exports = {
  ...
  BYTES32: {
    ...
    BAD_ID: web3Instance.utf8ToHex("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"),
    TEST: [
      web3Instance.utf8ToHex("12345670123456701234567012345670"),
      web3Instance.utf8ToHex("12345671123456711234567112345671"),
      web3Instance.utf8ToHex("12345672123456721234567212345672"),
      web3Instance.utf8ToHex("12345673123456731234567312345673"),
      web3Instance.utf8ToHex("12345674123456741234567412345674"),
      web3Instance.utf8ToHex("12345675123456751234567512345675"),
      web3Instance.utf8ToHex("12345676123456761234567612345676"),
      web3Instance.utf8ToHex("12345677123456771234567712345677"),
      web3Instance.utf8ToHex("12345678123456781234567812345678"),
      web3Instance.utf8ToHex("12345679123456791234567912345679"),
    ]
  },
  BYTES: {
    EMPTY: web3Instance.utf8ToHex(""),
    BAD_SIGNATURE: web3Instance.utf8ToHex(
